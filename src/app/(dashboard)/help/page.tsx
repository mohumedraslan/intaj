...
const helpTopics = [
  {
    ...
    answer: "You can train your agent in two ways. Go to the &apos;Manage&apos; page for your agent. Use the &apos;Knowledge Base&apos; tab to upload files (like PDFs or text documents) containing your business information. Use the &apos;FAQs&apos; tab to add specific question-and-answer pairs for common queries."
  },
  {
  ...
  },
  {
    ...
    answer: "The Free plan is great for getting started and allows you to create one agent with limited monthly messages. The Pro and Business plans offer more agents, a much higher message limit, priority support, and other advanced features. You can see all the details on our 'Pricing' page."
  },
  {
  ...
  {
    question: "Can I embed my agent on my website?",
    answer: "Yes! Once you've created and trained your agent, you can embed it on your website. We provide a simple JavaScript snippet that you can add to your website. The agent will appear as a chat widget that visitors can interact with."
  },
  {
    question: "How do I view analytics for my agent?",
    answer: "Navigate to your agent's page and click the 'Analytics' button. You'll see metrics like total messages, conversation history, and user feedback. This helps you understand how your agent is performing and identify areas for improvement."
  },
  {
    question: "What file types can I upload to train my agent?",
  ...
  },
  {
    ...
    answer: "In the Analytics section of your agent, you can review recent conversations and provide feedback on individual AI responses using the thumbs up/down buttons. This helps us improve the AI's performance for your specific use case."
  }
];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 p-6">
      <div className="text-center space-y-4">
        <h1 className="text-3xl font-bold text-text">Help & Documentation</h1>
        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Create Your Agent</h3>
              <p className="text-sm text-gray-600">
                Go to your dashboard and click &quot;Create New Agent&quot;. Give it a name and define its personality.
              </p>
            </div>
            <div className="space-y-2">
              <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-semibold">
              ...
              <p className="text-sm text-gray-600">
                Upload your business documents and create FAQs to teach your agent about your business.
              </p>
            </div>
            <div className="space-y-2">
              <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-semibold">
